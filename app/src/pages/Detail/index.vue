...
export default {
  ...
  computed: {
    ...
    // skuInfo.skuImageList 报错，1.不能读取[0]=undefined 2.[0]里没有imgUrl undefined, 至少[0]是一个空对象
    skuImageList() {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      try {
        ...
        // 路由跳转
        // 传参数 商品属性和数量(可以用query传参但不合适-适合传递比较简单的数据)
        // 复杂的数据可以用 回话存储(不持久化，回话结束数据会消失)
