<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeDefault(address, addressInfo)">
          ...
          <span class="s3" v-shou="address.isDefault == 1">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
    ...
    <div class="sub clearFix">
      <a class="subBtn" @click="submitOrde">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    // 提交订单的最终地址 = 选定的默认地址(该账号没数据，会报错，选择返回一个空对象)
    userDefaultAddress() {
  ...
  methods: {
    // 修改默认地址 isDefault 0/fales 1/true
